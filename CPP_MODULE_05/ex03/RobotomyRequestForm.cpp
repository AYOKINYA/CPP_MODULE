...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/14 19:43:44 by jkang             #+#    #+#             */
/*   Updated: 2020/08/14 19:43:59 by jkang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
RobotomyRequestForm::RobotomyRequestForm(RobotomyRequestForm const &copy) : Form("tmp", 72, 45, 0), target("")
{
    *this = copy;
}
